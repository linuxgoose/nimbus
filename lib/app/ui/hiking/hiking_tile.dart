...
import 'package:nimbus/app/ui/hiking/view/hiking_page.dart';

class HikingTile extends StatelessWidget {
  const HikingTile({super.key});
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'UV index, visibility & trail conditions',
